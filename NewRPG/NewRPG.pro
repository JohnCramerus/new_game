...
unrealRootPath=/home/john/UnrealEngine
NewRPGRootPath=/home/john/new_game/NewRPG

gameProjectFile=/home/john/new_game/NewRPG/NewRPG.uproject
...
include(NewRPGSource.pri)
include(NewRPGHeader.pri)
include(NewRPGConfig.pri)
include(NewRPGIncludes.pri)
include(NewRPGDefines.pri)

NewRPG-Linux-Debug.commands = $$build NewRPG Linux Debug  -project="\"$$gameProjectFile\"" $$args
NewRPG-Linux-DebugGame.commands = $$build NewRPG Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
NewRPG-Linux-Shipping.commands = $$build NewRPG Linux Shipping  -project="\"$$gameProjectFile\"" $$args
NewRPG-Linux-Test.commands = $$build NewRPG Linux Test  -project="\"$$gameProjectFile\"" $$args
NewRPG.commands = $$build NewRPG Linux Development  -project="\"$$gameProjectFile\"" $$args

NewRPGEditor-Linux-Debug.commands = $$build NewRPGEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
NewRPGEditor-Linux-DebugGame.commands = $$build NewRPGEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
NewRPGEditor-Linux-Shipping.commands = $$build NewRPGEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
NewRPGEditor-Linux-Test.commands = $$build NewRPGEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
NewRPGEditor.commands = $$build NewRPGEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	NewRPG-Linux-Debug \
	NewRPG-Linux-DebugGame \
	NewRPG-Linux-Shipping \
	NewRPG-Linux-Test \
	NewRPG \
	NewRPGEditor-Linux-Debug \
	NewRPGEditor-Linux-DebugGame \
	NewRPGEditor-Linux-Shipping \
	NewRPGEditor-Linux-Test \
	NewRPGEditor \
